...
void chanceToCreateRainbowAsteroid() {
  if (mousePressed) {
    ...
    if (chanceOfAsteroid <= 10) {        // if it is (currently a 5% chance)
      ...
      if (edge < 25) {          // a roll of 0-24 represents the top of the screen  
        ...
        arrayListOfAsteroids.add(new RainbowAsteroid(random(width), 0, random(-8, 8), random(-8, 8), random(25, 60), random(255)));
      } else if (edge < 50) {    // a roll of 25-49 represents the bottom of the screen

        arrayListOfAsteroids.add(new RainbowAsteroid(random(width), height, random(-8, 8), random(-8, -8), random(25, 60), random(255)));
      } else if (edge < 75) {    // a roll of 50-74 represents the left of the screen

        arrayListOfAsteroids.add(new RainbowAsteroid(0, random(height), random(8, 8), random(-8, 8), random(25, 60), random(255)));
      } else {                   // a roll of 75 and up represents the right of the screen

        arrayListOfAsteroids.add(new RainbowAsteroid(width, random(height), random(8, 8), random(-8, 8), random(25, 60), random(255)));
      }
    }
  }
}